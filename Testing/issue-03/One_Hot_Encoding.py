...
class TestOHE(unittest.TestCase):
    """
    Test cases for the fit_transform function.
    """
    def test_first(self):
        """
        Test for a single category.
        """
        self.assertEqual(fit_transform("SOS"), [("SOS", [1])])
    ...
    def test_fourth(self):
        """
        Test for an incorrect result.
        """
        self.assertNotIn(fit_transform("Igor"), [("Igor", 11), 12])
